...
#define BRD_REV_1P10 0
#define BRD_REV_1P12 1
...
#define BOARD_REV_ID_PAD_CTRL (PAD_CTL_PUS_100K_DOWN | PAD_CTL_PUE | \
	PAD_CTL_PKE | PAD_CTL_ODE | PAD_CTL_SPEED_HIGH | PAD_CTL_DSE_80ohm |    \
                PAD_CTL_SRE_FAST | PAD_CTL_HYS | PAD_CTL_LVE)
...
#define PINID_LCD_RD_REV1P10	IMX_GPIO_NR(3, 11)
#define PINID_LCD_RS_REV1P10	IMX_GPIO_NR(2, 19)
#define PINID_LCD_RD_REV1P12	IMX_GPIO_NR(2, 16)
#define PINID_LCD_RS_REV1P12	IMX_GPIO_NR(2, 18)
...
#define PINID_MIPI_RSTN_REV1P10	IMX_GPIO_NR(3, 10)
#define PINID_MIPI_RSTN_REV1P12	IMX_GPIO_NR(3, 5)
...
// WaRP Board Version GPIO
#define BRD_REV_GPIO_0		IMX_GPIO_NR(5, 7)
#define BRD_REV_GPIO_1		IMX_GPIO_NR(5, 9)
#define BRD_REV_GPIO_2		IMX_GPIO_NR(5, 12)
#define BRD_REV_GPIO_CHK	IMX_GPIO_NR(5, 10)

#define FXOS8700_RSTN		IMX_GPIO_NR(3, 19)
...
extern struct warp_cfg warp_cfg_info;

static iomux_v3_cfg_t const brd_rev_pads[] = {
	MX6_PAD_SD1_DAT4__GPIO_5_12 | MUX_PAD_CTRL(BOARD_REV_ID_PAD_CTRL),
	MX6_PAD_SD1_DAT5__GPIO_5_9 | MUX_PAD_CTRL(BOARD_REV_ID_PAD_CTRL),
	MX6_PAD_SD1_DAT6__GPIO_5_7 | MUX_PAD_CTRL(BOARD_REV_ID_PAD_CTRL),
	MX6_PAD_SD1_DAT7__GPIO_5_10 | MUX_PAD_CTRL(WARP_GPIO_PAD_CTRL)
};

static iomux_v3_cfg_t const fxos_rstn_pads[] = {
	MX6_PAD_HSIC_DAT__GPIO_3_19 | MUX_PAD_CTRL(WARP_GPIO_PAD_CTRL)
};

static iomux_v3_cfg_t const mcu8080display_pads_common[] = {
	...
	MX6_PAD_LCD_CLK__LCDIF_WR_RWN | MUX_PAD_CTRL(LCD_PAD_CTRL),	// LCD_WRX(SSD)/LCD_WR_RWn(MX6SL)
	MX6_PAD_LCD_HSYNC__LCDIF_CS | MUX_PAD_CTRL(LCD_PAD_CTRL), 	// LCD_CSX(SSD)/LCD_CS(MX6SL)
...
static iomux_v3_cfg_t const mcu8080display_pads_rev1p10[] = {
	MX6_PAD_LCD_DAT23__GPIO_3_11 | MUX_PAD_CTRL(LCD_PAD_CTRL),	// LCD_RDX(SSD)/LCD_RD_E(MX6SL)
	MX6_PAD_LCD_RESET__GPIO_2_19 | MUX_PAD_CTRL(LCD_PAD_CTRL), 	// LCD_DCX(SSD) LCD_RS(MX6SL)
	MX6_PAD_LCD_DAT22__GPIO_3_10 | MUX_PAD_CTRL(LCD_PAD_CTRL),	// MIPI_RSTn
};


static iomux_v3_cfg_t const mcu8080display_pads_rev1p12[] = {
	MX6_PAD_LCD_ENABLE__GPIO_2_16 | MUX_PAD_CTRL(LCD_PAD_CTRL),	// LCD_RDX(SSD)/LCD_RD_E(MXSL)
	MX6_PAD_LCD_VSYNC__GPIO_2_18 | MUX_PAD_CTRL(LCD_PAD_CTRL), 	// LCD_DCX(SSD) LCD_RS(MX6SL)
	MX6_PAD_LCD_DAT17__GPIO_3_5 | MUX_PAD_CTRL(LCD_PAD_CTRL),	// MIPI_RSTn
};
