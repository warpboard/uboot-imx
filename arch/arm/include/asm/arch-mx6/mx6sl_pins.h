...
enum {
	...
	MX6_PAD_SD1_DAT4__GPIO_5_12		= IOMUX_PAD(0x054C, 0x0244, 5, 0x0000, 0, 0),
	...
	MX6_PAD_SD1_DAT6__GPIO_5_7		= IOMUX_PAD(0x0554, 0x024C, 5, 0x0000, 0, 0),
	MX6_PAD_SD1_DAT7__USDHC1_DAT7           = IOMUX_PAD(0x0558, 0x0250, 0, 0x0000, 0, 0),
	MX6_PAD_SD1_DAT7__GPIO_5_10		= IOMUX_PAD(0x0558, 0x0250, 5, 0x0000, 0, 0),
	...
	// Bit bang I2C configuration for setting FXOS8700 mode
	MX6_PAD_ECSPI2_SCLK__GPIO_4_12		= IOMUX_PAD(0x0370, 0x0080, 5, 0x0000, 0, 0),
	MX6_PAD_ECSPI2_MOSI__GPIO_4_13		= IOMUX_PAD(0x036C, 0x007C, 5, 0x0000, 0, 0),
	MX6_PAD_ECSPI2_MISO__GPIO_4_14		= IOMUX_PAD(0x0368, 0x0078, 5, 0x0000, 0, 0),
	MX6_PAD_ECSPI2_SS0__GPIO_4_15		= IOMUX_PAD(0x0374, 0x0084, 5, 0x0000, 0, 0),

	MX6_PAD_HSIC_STROBE__GPIO_3_20		= IOMUX_PAD(0x0448, 0x0158, 5, 0x0000, 0, 0),
	MX6_PAD_HSIC_DAT__GPIO_3_19		= IOMUX_PAD(0x0444, 0x0154, 5, 0x0000, 0, 0),

	MX6_PAD_AUD_TXFS__PWM3_PWMO		= IOMUX_PAD(0x02BC, 0x0064, 1, 0x0000, 0, 0),
	MX6_PAD_AUD_TXFS__GPIO_1_4		= IOMUX_PAD(0x02BC, 0x0064, 5, 0x0000, 0, 0),
	MX6_PAD_KEY_ROW2__GPIO_3_29		= IOMUX_PAD(0x049C, 0x0194, 5, 0x0000, 0, 0),

	MX6_PAD_LCD_DAT0__LCDIF_DAT_0		= IOMUX_PAD(0x04B8, 0x01B0, 0, 0x0778, 1, 0),
	MX6_PAD_LCD_DAT0__GPIO_2_20		= IOMUX_PAD(0x04B8, 0x01B0, 5, 0x0000, 0, 0),

	MX6_PAD_LCD_DAT1__LCDIF_DAT_1		= IOMUX_PAD(0x04BC, 0x01B4, 0, 0x077C, 1, 0),
	MX6_PAD_LCD_DAT1__GPIO_2_21		= IOMUX_PAD(0x04BC, 0x01B4, 5, 0x0000, 0, 0),

	MX6_PAD_LCD_DAT2__LCDIF_DAT_2		= IOMUX_PAD(0x04E8, 0x01E0, 0, 0x0780, 1, 0),
	MX6_PAD_LCD_DAT2__GPIO_2_22		= IOMUX_PAD(0x04E8, 0x01E0, 5, 0x0000, 0, 0),

	MX6_PAD_LCD_DAT3__LCDIF_DAT_3		= IOMUX_PAD(0x04FC, 0x01F4, 0, 0x0784, 1, 0),
	MX6_PAD_LCD_DAT3__GPIO_2_23		= IOMUX_PAD(0x04FC, 0x01F4, 5, 0x0000, 0, 0),

	MX6_PAD_LCD_DAT4__LCDIF_DAT_4		= IOMUX_PAD(0x0500, 0x01F8, 0, 0x0788, 1, 0),
	MX6_PAD_LCD_DAT4__GPIO_2_24		= IOMUX_PAD(0x0500, 0x01F8, 5, 0x0000, 0, 0),

	MX6_PAD_LCD_DAT5__LCDIF_DAT_5		= IOMUX_PAD(0x0504, 0x01FC, 0, 0x078C, 1, 0),
	MX6_PAD_LCD_DAT5__GPIO_2_25		= IOMUX_PAD(0x0504, 0x01FC, 5, 0x0000, 0, 0),

	MX6_PAD_LCD_DAT6__LCDIF_DAT_6		= IOMUX_PAD(0x0508, 0x0200, 0, 0x0790, 1, 0),
	MX6_PAD_LCD_DAT6__GPIO_2_26		= IOMUX_PAD(0x0508, 0x0200, 5, 0x0000, 0, 0),

	MX6_PAD_LCD_DAT7__LCDIF_DAT_7		= IOMUX_PAD(0x050C, 0x0204, 0, 0x0794, 1, 0),
	MX6_PAD_LCD_DAT7__GPIO_2_27		= IOMUX_PAD(0x050C, 0x0204, 5, 0x0000, 0, 0),

	MX6_PAD_LCD_DAT8__LCDIF_DAT_8		= IOMUX_PAD(0x0510, 0x0208, 0, 0x0798, 1, 0),
	MX6_PAD_LCD_DAT8__GPIO_2_28		= IOMUX_PAD(0x0510, 0x0208, 5, 0x0000, 0, 0),

	MX6_PAD_LCD_DAT9__LCDIF_DAT_9		= IOMUX_PAD(0x0514, 0x020C, 0, 0x079C, 1, 0),
	MX6_PAD_LCD_DAT9__GPIO_2_29		= IOMUX_PAD(0x0514, 0x020C, 5, 0x0000, 0, 0),

	MX6_PAD_LCD_DAT10__LCDIF_DAT_10 	= IOMUX_PAD(0x04C0, 0x01B8, 0, 0x07A0, 1, 0),
	MX6_PAD_LCD_DAT10__GPIO_2_30 		= IOMUX_PAD(0x04C0, 0x01B8, 5, 0x0000, 0, 0),

	MX6_PAD_LCD_DAT11__LCDIF_DAT_11		= IOMUX_PAD(0x04C4, 0x01BC, 0, 0x07A4, 1, 0),
	MX6_PAD_LCD_DAT11__GPIO_2_31		= IOMUX_PAD(0x04C4, 0x01BC, 5, 0x0000, 0, 0),

	MX6_PAD_LCD_DAT12__LCDIF_DAT_12		= IOMUX_PAD(0x04C8, 0x01C0, 0, 0x07A8, 1, 0),
	MX6_PAD_LCD_DAT12__GPIO_3_0		= IOMUX_PAD(0x04C8, 0x01C0, 5, 0x0000, 0, 0),

	MX6_PAD_LCD_DAT13__LCDIF_DAT_13		= IOMUX_PAD(0x04CC, 0x01C4, 0, 0x07AC, 1, 0),
	MX6_PAD_LCD_DAT13__GPIO_3_1		= IOMUX_PAD(0x04CC, 0x01C4, 5, 0x0000, 0, 0),

	MX6_PAD_LCD_DAT14__LCDIF_DAT_14		= IOMUX_PAD(0x04D0, 0x01C8, 0, 0x07B0, 1, 0),
	MX6_PAD_LCD_DAT14__GPIO_3_2		= IOMUX_PAD(0x04D0, 0x01C8, 5, 0x0000, 0, 0),

	MX6_PAD_LCD_DAT15__LCDIF_DAT_15		= IOMUX_PAD(0x04D4, 0x01CC, 0, 0x07B4, 1, 0),
	MX6_PAD_LCD_DAT15__GPIO_3_3		= IOMUX_PAD(0x04D4, 0x01CC, 5, 0x0000, 0, 0),

	MX6_PAD_LCD_DAT17__GPIO_3_5		= IOMUX_PAD(0x04DC, 0x01D4, 5, 0x0000, 0, 0),

	MX6_PAD_LCD_DAT23__GPIO_3_11		= IOMUX_PAD(0x04F8, 0x01F0, 5, 0x0000, 0, 0),

	MX6_PAD_LCD_CLK__LCDIF_WR_RWN		= IOMUX_PAD(0x04B4, 0x01AC, 2, 0x0000, 0, 0),
	MX6_PAD_LCD_CLK__GPIO_2_15		= IOMUX_PAD(0x04B4, 0x01AC, 5, 0x0000, 0, 0),

	MX6_PAD_LCD_HSYNC__LCDIF_CS		= IOMUX_PAD(0x051C, 0x0214, 2, 0x0000, 0, 0),
	MX6_PAD_LCD_HSYNC__GPIO_2_17		= IOMUX_PAD(0x051C, 0x0214, 5, 0x0000, 0, 0),

	MX6_PAD_LCD_RESET__GPIO_2_19		= IOMUX_PAD(0x0520, 0x0218, 5, 0x0000, 0, 0),
	MX6_PAD_AUD_MCLK__PWM4_PWMO		= IOMUX_PAD(0x02A4, 0x004C, 1, 0x0000, 0, 0),
	MX6_PAD_LCD_DAT16__GPIO_3_4		= IOMUX_PAD(0x04D8, 0x01D0, 5, 0x0000, 0, 0),
	MX6_PAD_LCD_DAT19__GPIO_3_7		= IOMUX_PAD(0x04E4, 0x01DC, 5, 0x0000, 0, 0),
	MX6_PAD_LCD_DAT20__GPIO_3_8		= IOMUX_PAD(0x04EC, 0x01E4, 5, 0x0000, 0, 0),
	MX6_PAD_LCD_DAT21__GPIO_3_9		= IOMUX_PAD(0x04F0, 0x01E8, 5, 0x0000, 0, 0),
	MX6_PAD_LCD_DAT22__GPIO_3_10		= IOMUX_PAD(0x04F4, 0x01EC, 5, 0x0000, 0, 0),

	MX6_PAD_LCD_ENABLE__LCDIF_RD_E		= IOMUX_PAD(0x0518, 0x0210, 2, 0x0000, 0, 0),
	MX6_PAD_LCD_ENABLE__GPIO_2_16		= IOMUX_PAD(0x0518, 0x0210, 5, 0x0000, 0, 0),

	MX6_PAD_LCD_VSYNC__LCDIF_RS		= IOMUX_PAD(0x0524, 0x021C, 2, 0x0000, 0, 0),
	MX6_PAD_LCD_VSYNC__GPIO_2_18		= IOMUX_PAD(0x0524, 0x021C, 5, 0x0000, 0, 0)
};
