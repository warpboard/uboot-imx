 ...
 * Initial Android config: Diego Rondini
 *
...
#ifndef WARP_ANDROID_H
#define WARP_ANDROID_H
...
#define CONFIG_FASTBOOT_MANUFACTURER_STR  "Revolution Robotics"
#define CONFIG_FASTBOOT_PRODUCT_NAME_STR "WaRP Board"
